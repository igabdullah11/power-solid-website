...
//       <div className="border-t border-[#d4af37]/30 mb-8" />
...
//               />
//               <span className="text-xl font-bold">Power Solid</span>
//             </div>
//             <p className="text-white/70 text-sm leading-relaxed">
//               Building excellence through professional engineering and construction services.
//             </p>
//           </div>
...
//               <li>
//                 <Link href="/" className="text-white/70 hover:text-[#d4af37] transition-colors text-sm">
//                   HOME
//                 </Link>
//               </li>
//               <li>
//                 <Link href="/about-us" className="text-white/70 hover:text-[#d4af37] transition-colors text-sm">
//                   ABOUT US
//                 </Link>
//               </li>
//               <li>
//                 <Link href="/services" className="text-white/70 hover:text-[#d4af37] transition-colors text-sm">
//                   SERVICES
//                 </Link>
//               </li>
//             </ul>
...
//           <div>
//             <h3 className="text-[#d4af37] font-semibold mb-4">Services</h3>
//             <ul className="space-y-2">
//               <li className="text-white/70 text-sm">Engineering</li>
//               <li className="text-white/70 text-sm">Construction</li>
//               <li className="text-white/70 text-sm">Consulting</li>
//             </ul>
//           </div>
...
//                 <a href="tel:+966551429094" className="text-white/70 hover:text-[#d4af37] transition-colors text-sm">
//                   +966 55 142 9094
//                 </a>
//               </li>
//               <li className="flex items-start gap-2">
...
//             <p>© 2025 Power Solid. All rights reserved.</p>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div>
            <div className="flex items-center gap-3 mb-4">
              <Image
                ...
                className="w-10 h-10 object-contain"
              />
              <span className="text-xl font-bold">Power Solid Company</span>
            </div>
            <p className="text-white/70 text-sm leading-relaxed">
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/projects" className="text-white/70 hover:text-[#d4af37] transition-colors text-sm">
                  Projects
                </Link>
              </li>
              <li>
                <Link href="/certificates" className="text-white/70 hover:text-[#d4af37] transition-colors text-sm">
                  Certificates
                </Link>
              </li>
              <li>
                <Link href="/contact-us" className="text-white/70 hover:text-[#d4af37] transition-colors text-sm">
                  Contact Us
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li className="flex items-start gap-2">
                <Phone className="w-4 h-4 text-[#d4af37] mt-1 flex-shrink-0" />
                <a href="tel:+966552163720" className="text-white/70 hover:text-[#d4af37] transition-colors text-sm">
                  +966 55 216 3720
                </a>
              </li>
